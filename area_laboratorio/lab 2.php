...
<head>
 ...
 <script src="dist/GameScalePlugin.js"></script>
  ...
  <header>
    <nav class="navbar">
      ...
      <div class="controle">
        ...
        <button class="fechar" onclick="sair_laboratorio()"><i class="fa fa-sign-out" aria-hidden="true"></i>VOLTAR</button>
      </div>
    </nav>
  </header>
...
<!--
  ...
  // qual o id da pratica atual
                  ...
                  <div class="caixas">
                    ...
                    foreach ($lista as $val):
                      ...
                      <label class="opcao" data-id="<?php echo $val['id']?>">    
                        ...
                        <button type="button" data-id="<?php echo $val['id']; ?>" class="btn m-3 botao btn-armario-pegar">Selecionar</button>
              ...
              <div class="col-2">
                <div class="informacaoselecionados">
                  <div class="rotulo">
                    ...
                    <div class="armario-lotado alert alert-danger" role="alert" style="display:none">
                      <p>Não é possível acrescentar novos itens à sua lista, pois ela já ocupará todo o espaço livre na bancada</p>
                    </div>
                    
                  </div>
                  <div class="botoesfinais">
                    <div class="float-left">
                      <button type="button" id="fechar-armario" class="btn vermelho btn-default mt-2 mb-2">Cancelar</button>
                    </div>
                    <div class="float-right">
                      <button type="button" class="btn verde btn-primary mt-2 mb-2 btn-armario-adicionar">Adicionar</button>
                    </div>
                  </div>
                </div>
              </div>
