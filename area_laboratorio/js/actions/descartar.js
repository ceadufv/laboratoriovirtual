...
* @valid_source ["ambientado(bequer)", "ambientado(pipeta)", "ambientado(balao)", "cheio(bequer)", "cheio(pipeta)", "cheio(balao)", "cheio(micropipeta)", "cheio(bequer_descarte)"]
* @valid_target ["bequer_descarte"]
* @single true
