...
--
-- Host: 127.0.0.1
-- Generation Time: 04-Out-2019 às 16:13
...
(1, 'Administrador', 'admin@gmail.com', '7c4a8d09ca3762af61e59520943dc26494f8941b', 2, 'admin');
...
--
ALTER TABLE `disciplinas`
  MODIFY `id_disciplina` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT for table `modelo_pratica`
--
ALTER TABLE `modelo_pratica`
  MODIFY `id_modelo_pratica` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `modelo_pratica_arquivo`
--
ALTER TABLE `modelo_pratica_arquivo`
  MODIFY `cod_moprar` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;

--
-- AUTO_INCREMENT for table `modelo_pratica_solucao`
--
ALTER TABLE `modelo_pratica_solucao`
  MODIFY `cod_moprsi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
